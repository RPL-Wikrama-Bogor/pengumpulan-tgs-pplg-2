        ...
        <table class="table table-striped table-bordered tabel-hover">
            <thead>
                <a href="{{ route('user.create') }}" type="submit" class="btn"
                    style="color:white; background-color:grey; margin-bottom:10px; margin-top:30px;">Tambah</a>
                <tr>
                    <th>No</th>
                    <th>Nama</th>
                    <th>Email</th>
