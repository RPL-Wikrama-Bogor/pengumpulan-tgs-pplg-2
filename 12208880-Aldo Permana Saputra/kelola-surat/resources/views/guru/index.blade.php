...
@section('content')
    ...
    <h3 style="weight:400;">Data Guru</h3>

    <div class="d-flex">
        <h6 style="margin-right: 0.4rem;"><a class="nav-link text-secondary" href="/home">Home /</a></h6>
        <h6><a class="nav-link text-primary" href="">Data Guru</a></h6>
    </div>
        ...
        <table class="table table-striped table-bordered tabel-hover">
            <thead>
                <a href="{{ route('user.create') }}" type="submit" class="btn"
                    style="color:white; background-color:grey; margin-bottom:10px; margin-top:30px;">Tambah Pengguna</a>
                <tr>
                    <th>No</th>
                    <th>Nama</th>
                    <th>Email</th>
