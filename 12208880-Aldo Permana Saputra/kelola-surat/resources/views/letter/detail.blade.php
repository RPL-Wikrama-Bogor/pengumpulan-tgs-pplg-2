...
@section('content')
    <div class="container bg-light p-5" style="border-radius: 10px;">
        ...
        <div class="d-flex">
            ...
            <h6 style="margin-right: 0.4rem;"><a class="nav-link" style="color: rgb(0, 98, 255)" href="/dashboard">Home /</a>
            </h6>
            <h6 style="margin-right: 0.4rem;"><a class="nav-link" style="color: rgb(0, 98, 255)"
