        ...
        <form action="{{ route('admin.order.search') }}" method="GET">
            ...
            <div class=" mt-5 " style="">
                ...
                <div class="card d-flex justify-content-end">
                    <a href="{{ route('admin.order.download-excel') }}" class="btn btn-success d-flex justify-content-center m-5">Export Excel</a>
                ...
                <tbody>
                    ...
                    @foreach ($orders as $order)
                        <tr>
                            ...
                            <th><a href="{{ route('admin.order.admindownload-pdf', $order['id']) }}" class="btn-print">Cetak (.pdf)</a></th>
                        </tr>
                    @endforeach
