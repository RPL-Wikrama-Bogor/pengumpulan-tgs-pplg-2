...
// craetePool: mneghubungkan project ke db hanya sesekali di awal
const pool = mysql.createPool(dbConfig)

// kalau ada err, err nya dimunculkan di console
pool.on('error', (err) => {
    console.error(err)
})
...
// membuat format API kalau http response status codenya 200
