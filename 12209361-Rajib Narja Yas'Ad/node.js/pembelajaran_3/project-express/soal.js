// SOAL
// Buatkan fungsi dengan menggunakan primise untuk menjalankan tugas berdasarkan data dibawah
...
function soal(Task, succes) {
  return new Promise((resolve, reject) => {
    const tugasTerkait = tugas.find((t) => t.nama === Task);
    if (tugasTerkait) {
      setTimeout(() => {
        if (succes) {
      ...
      reject(`Tugas ${Task} tidak ditemukan`);
    }
  });
}
