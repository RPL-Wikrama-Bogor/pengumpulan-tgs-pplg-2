...
<div class="container mt-3">
    <div class="row">
        <div class="col-4">
            <form action="{{ route('admin.order.searchAdmin')}}" class="d-flex" method="GET">
                <input type="date" class="form-control" name="searchAdmin" placeholder="Cari...">
                ...
                <a href="{{ route('admin.order.data')}}" style="text-decoration: none;color:white;">reset</a>
            </button>
            </form>
        </div>
        <div class="col-4"></div>
        <div class="col-4">
            <div class="mt-5">
                <div class="d-flex justify-content-end">
                    <a href="{{ route('admin.order.download-excel')}}" class="btn btn-sm btn-primary ml-2 mt-5">export excel</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <table class="table table-stripped w-100 tabble mt-3 bordered table-hovered table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                {{-- <td>    <a href="{{ route('order.download', $order['id']) }}" class="btn btn-sm btn-primary ml-2">Cetak (.pdf)</a></td> --}}
            </tr>
            @endforeach
        </tbody>
    </table>
