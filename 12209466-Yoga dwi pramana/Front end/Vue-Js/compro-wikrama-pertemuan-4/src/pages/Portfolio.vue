<template>
    <div class="container">
        <div class="portfolio">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui, repellat. Aliquid magnam in accusantium ex
                culpa, sapiente fugit cum tenetur.</p>
            <div class="category">
...
export default {
    ...
    // },
    // beforeMount() {
    //     console.log(documnet.querySelector('portfolio'));
