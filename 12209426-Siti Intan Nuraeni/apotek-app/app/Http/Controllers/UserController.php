...
{
    // karna func diakses setelah form di submit , jadi perlu parameter request
    public function authLogin(Request $request)
    // (Request $request) -> berfungsi untuk mengambil data yang di input oleh user
    {
        // validasi datanya
        $request->validate([
            // format nya harus berupa @gmail 
            'email' => 'required|email:dns',
            // validasi wajib di iisi
            'password' => 'required',
        ]);
        ...
        if(Auth::attempt($user)) {
            // aakses routing php
            // untuk memanggil di web.php 
            // perbedaan redirect() manggil lewat path
            // redirect()->route ?? manggil lewat name
