        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    {{-- Auth::check -> cek apakah sudah ada login atau belum, kalau ada munculin menu navnya --}}
                    @if (Auth::check())
                        <li class="nav-item">
                        ...
                        @if (Auth::user()->role == 'admin')
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('admin.order.data')}}" >Data Pembelian</a>
                        </li>
                        @else (Auth::user()->role == 'cashier')
                        <li class="nav-item">
