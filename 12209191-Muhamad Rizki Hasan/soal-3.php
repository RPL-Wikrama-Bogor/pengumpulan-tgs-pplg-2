...
if (isset($_POST['submit'])) {
    ...
    if ($bilangan_satu == $bilangan_dua && $bilangan_satu == $bilangan_tiga) {
        echo "Bilangan pertama : " . $bilangan_satu . " || Bilangan Kedua : " . $bilangan_dua . " || Bilangan Ketiga " . $bilangan_tiga . " ||  <b>  Bilangan sama besar </b>";
    } else if ($bilangan_satu >= $bilangan_dua && $bilangan_satu >= $bilangan_tiga ) {
        echo "Bilangan pertama : " . $bilangan_satu . " || Bilangan Kedua : " . $bilangan_dua . " || Bilangan Ketiga " . $bilangan_tiga . " || " . "<b>" .  $bilangan_satu . "</b>";
    } else if ($bilangan_dua >= $bilangan_satu && $bilangan_dua >= $bilangan_tiga) {
        echo "Bilangan pertama : " . $bilangan_satu . " || Bilangan Kedua : " . $bilangan_dua . " || Bilangan Ketiga " . $bilangan_tiga . " || ". "<b>"  . $bilangan_dua . "</b>";
    } else if ($bilangan_tiga >= $bilangan_satu && $bilangan_tiga >= $bilangan_dua) {
        echo "Bilangan pertama : " . $bilangan_satu . " || Bilangan Kedua : " . $bilangan_dua . " || Bilangan Ketiga " . $bilangan_tiga . " ||  <b>" . $bilangan_tiga . "</b>";
    } 
}
?>