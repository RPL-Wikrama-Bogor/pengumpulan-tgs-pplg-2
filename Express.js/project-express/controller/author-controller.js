...
const addAuthor = (req, res) =>{
    ...
    pool.getConnection((err, connection) =>{
        ...
        connection.query(query, [data], (err, result) =>{
            ...
            responseSuccess(res, result, 'author seccessfuly addes');
        });
        connection.release();
    })
}
...
const getAuthor = (req, res) =>{
    ...
    pool.getConnection((err, connection) => {
        ...
        connection.query(query, (err, result) =>{
            ...
            responseSuccess(res, result, 'Author Successfuly fetched');
        });
        connection.release();
    });
}
...
const editAuthor = (req, res) =>{
    ...
    pool.getConnection((err, connection) =>{
        ...
        connection.query(query, [data], (err, result) =>{
            ...
            responseSuccess(res, result, 'Author successfuly update')
        })
        connection.release()
    })
}
...
const deleteAuthor = (req, res) =>{
    ...
    pool.getConnection((err, connection) =>{
        ...
        connection.query(query, (err, result) =>{
            ...
            if(result.affectedRows == 0){
                responseAuthorNotFound(ress)
                return
            }

            responseSuccess(res, result, 'Author successfuly deleted')
